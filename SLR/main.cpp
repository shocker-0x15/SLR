...
//    TiledImage2DRef IBLImage = TiledImage2D::create("images/Malibu_Overlook_3k.exr", &DefaultAllocator::instance());
    ...
    InfiniteSphereNodeRef envNode = createShared<InfiniteSphereNode>(&scene, IBLTex, Spectrum(10.0f));
